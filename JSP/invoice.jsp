        ...
        <div id="bill">
            ...
            <div class="details">
                ...
                <div class="addressDets">
                    <h4>Billed To</h4>
                    <p><% out.print(firstname+" "+rs.getString("l_name"));%></p>
                ...
                <div class="infoDate">
                    ...
                    <%
                        stmt=con.createStatement();
                        rs=stmt.executeQuery("SELECT billdate from billing where cust_id='"+Cid+"' and billno='"+billno+"'");
                        rs.next();
                    %>
                    ...
                    <section class="table-body">
                        <table>
                            ...
                            <tbody>
                                ...
                                int totalbillamt=0;
                                stmt=con.createStatement();
                                rs=stmt.executeQuery("SELECT * from billing where cust_id='"+Cid+"' and billno='"+billno+"'  ORDER BY billsr DESC");
                                while(rs.next()){
                                    sr++;
